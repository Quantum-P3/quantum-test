    ...
    a.extend(a.validator, {
      ...
      prototype: {
        ...
        showLabel: function (b, c) {
          ...
          g.length
            ...
            !c &&
              ...
              (g.text(''), 'string' == typeof this.settings.success ? g.addClass(this.settings.success) : this.settings.success(g, b)),
        ...
        previousValue: function (b) {
          return (
            a.data(b, 'previousValue') || a.data(b, 'previousValue', { old: null, valid: !0, message: this.defaultMessage(b, 'remote') })
          );
        },
        destroy: function () {
